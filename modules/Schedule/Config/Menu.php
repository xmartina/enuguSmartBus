 ...
 */
$layout = "layout";
$layout = $rolepermissionLibrary->menu($layout);
...
<?php if (($layout == true)  || ($fleet == true) || ($fitness == true)  || ($location == true)  || ($schedule == true)  || ($tax == true)  || ($payment_method == true)  || ($trip == true)  || ($coupon == true) || ($rating == true) || ($role == true)) : ?>
    <li>
            ...
            <ul class="nav-second-level">
                <li>
                    <a class="has-arrow" href="#" aria-expanded="false">
                        <?php echo lang("Localize.layout") ?>
                    </a>

                    <ul class="nav-third-level">
                        <?php
                        $layout_list = "layout_list";
                        $layout_list_result = $rolepermissionLibrary->read($layout_list);
                        ?>

                        <?php if ($layout_list_result == true) : ?>
                            <li class="<?php echo ($menuname == "layouts") ? "mm-active" : ""  ?>">
                                <a href="<?php echo base_url(route_to('index-layout')) ?>">
                                    <?php echo lang("Localize.layout_list") ?>
                                </a>
                            </li>
                        <?php endif ?>
