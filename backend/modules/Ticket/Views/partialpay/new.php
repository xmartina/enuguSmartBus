    ...
    <div class="card mb-4">
        <div class="card-body">
            ...
            <form action="<?php echo base_url(route_to('create-partialpaid')) ?>" id="MaxtimeForm" onsubmit="return this.checkValidity()" method="post" class="row g-3" accept-charset="utf-8" enctype="multipart/form-data">
                ...
                <div class="col-md-6 col-lg-2" id="payment_method">
                ...
                <div class="col-md-6 col-lg-2" id="grand">
                    ...
                    <input type="number" name="grandtotal" id="grandtotal" class="form-control" value="<?php echo $amountToPay ?>" readonly>
                </div>

                <div class="col-md-6 col-lg-3" id="partial">
                    ...
                    <input type="number" step="0.01" name="paidamount" id="paidamount" class="form-control" placeholder="<?php echo lang("Localize.partial") . ' ' . lang("Localize.payment") . ' ' . lang("Localize.amount") ?>" max="<?php echo $amountToPay ?>" autocomplete="off" required />
                </div>

                <div class="col-md-6 col-lg-3" id="detailpay">
