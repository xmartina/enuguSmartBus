...
<?php $this->section('content') ?>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form action="<?php echo base_url(route_to('create-cancel')) ?>" id="cancelfrom" method="post" class="row g-3" accept-charset="utf-8" enctype="multipart/form-data">
                ...
                <div class="row justify-content-center">
                    <div class="col-8">
                        ...
                        <div class="col-12 mt-3">
                            <label for="cancel_fee"><?php echo lang("Localize.cancel") ?> <?php echo lang("Localize.fee") ?> </label>
                            <input type="text" name="cancel_fee" id="cancel_fee" class="form-control" value="<?php echo old('cancel_fee') ?>" placeholder="<?php echo lang("Localize.cancel") ?> <?php echo lang("Localize.fee") ?>">
                        </div>

                        <div class="col-12 mt-3" id="payment_method">
                            <label for="pay_type_id"><?php echo lang("Localize.payment") ?> <?php echo lang("Localize.type") ?> </label>
                            <select class="form-select" name="pay_type_id" id="pay_type_id" required>
