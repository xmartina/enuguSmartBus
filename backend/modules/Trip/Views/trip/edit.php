                ...
                <div class="bg-light p-3 my-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="number" step="0.01" id="free_luggage_kg" name="free_luggage_kg" value="<?php echo esc(old('free_luggage_kg')) ?? $trip->free_luggage_kg ?? '0.00' ?>" class="form-control" placeholder="<?php echo lang("Localize.free") ?> <?php echo lang("Localize.luggage") ?> (in kg)">
                        </div>
                        <div class="col-md-6">
                            <label for="paid_max_luggage_pcs" class="form-label"><?php echo lang("Localize.paid") ?> <?php echo lang("Localize.luggage") ?> (max pcs)</label>
                            <input type="number" id="paid_max_luggage_pcs" name="paid_max_luggage_pcs" value="<?php echo esc(old('paid_max_luggage_pcs')) ?? $trip->paid_max_luggage_pcs  ?? '0.00' ?>" class="form-control" placeholder="<?php echo lang("Localize.paid") ?> <?php echo lang("Localize.luggage") ?> (max pcs)">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" step="0.01" id="price_pcs" name="price_pcs" value="<?php echo esc(old('price_pcs')) ?? $trip->price_pcs  ?? '0.00' ?>" class="form-control" placeholder="  <?php echo lang("Localize.paid") ?> <?php echo lang("Localize.luggage") ?> <?php echo lang("Localize.price") ?> (per pcs)">
                        </div>
                        <div class="col-md-6">
                            <label for="special_max_luggage_pcs" class="form-label"><?php echo lang("Localize.special") ?> <?php echo lang("Localize.luggage") ?> (max pcs)</label>
                            <input type="number" id="special_max_luggage_pcs" name="special_max_luggage_pcs" value="<?php echo esc(old('special_max_luggage_pcs')) ?? $trip->special_max_luggage_pcs  ?? '0.00' ?>" class="form-control" placeholder="<?php echo lang("Localize.special") ?> <?php echo lang("Localize.luggage") ?> (max pcs)">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" step="0.01" id="special_price_pcs" name="special_price_pcs" value="<?php echo esc(old('special_price_pcs')) ?? $trip->special_price_pcs  ?? '0.00' ?>" class="form-control" placeholder="  <?php echo lang("Localize.special") ?> <?php echo lang("Localize.luggage") ?> <?php echo lang("Localize.price") ?> (per pcs)">
                        </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="number" step="0.01" id="max_length" name="max_length" value="<?php echo esc(old('max_length')) ?? $trip->max_length  ?? '0.00' ?>" class="form-control" placeholder=" <?php echo lang("Localize.non") ?>  <?php echo lang("Localize.standard") ?> <?php echo lang("Localize.luggage") ?>  (Max length)">
                        </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="number" step="0.01" id="max_weight" name="max_weight" value="<?php echo esc(old('max_weight')) ?? $trip->max_weight ?? '0.00' ?>" class="form-control" placeholder="<?php echo lang("Localize.non") ?>  <?php echo lang("Localize.standard") ?> <?php echo lang("Localize.luggage") ?> (Max weight)">
                        </div>
