...
<?php if ($reportresult == true) : ?>
    ...
    <li class="<?php echo ($menuname == "reports") ? "mm-active" : ""  ?>">
        ...
        <ul class="nav-second-level">
            ...
            <?php
            $driver_report_list = "driver_report";
            $driver_report_list_result = $rolepermissionLibrary->read($driver_report_list);
            ?>

            <?php if ($driver_report_list_result == true) : ?>
                <li>
                    <a href="<?php echo base_url(route_to('driver-report')) ?>"><?php echo lang("Localize.driver_report") ?></a>
                </li>
            <?php endif ?>
