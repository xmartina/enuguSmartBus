<?php if ($rolepermissionLibrary->menu("website_setting")) : ?>
    <li>
            ...
            <ul class="nav-second-level">
                <li class="<?php echo ($menuname == "pages") ? "mm-active" : ""  ?>">
                    ...
                    <ul class="nav-third-level">
                        ...
                        <?php
                        $cookies = "refund_policy";
                        $cookies_result = $rolepermissionLibrary->read($cookies);
                        ?>
                        <?php if ($cookies_result == true) : ?>
                            <li><a href="<?php echo base_url(route_to('new-cooke')) ?>"><?php echo lang("Localize.refund_policy") ?></a></li>
                        <?php endif ?>
        ...
        <ul class="nav-second-level">
            ...
            <?php 
            if ($rolepermissionLibrary->read("live_chat") == true) : ?>
                <li class="<?php echo $menuname == "livechat" ? "mm-active" : ""  ?>">
                    <a href="<?php echo base_url(route_to('livechat')) ?>">
                        <?php echo lang("Localize.live_chat") ?>
                    </a>
                </li>
            <?php endif ?>
            ...
            <?php if ($rolepermissionLibrary->read("db_backup") == true) : ?>
                <li class="<?php echo $menuname == "backup" ? "mm-active" : ""  ?>">
                    <a href="<?php echo base_url(route_to('backupdb-list')) ?>">
