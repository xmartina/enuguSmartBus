    ...
    <div class="card-body">
        ...
        <form action="<?php echo base_url(route_to('update-websetting', $webseeting->id)) ?>" id="websettingedit" method="post" class="row g-3" accept-charset="utf-8" enctype="multipart/form-data">
            ...
            <div class="col-md-6 col-xl-2">
                ...
                <input type="text" id="max_days" name="max_days" value="<?php echo esc(old('max_days')) ?? $webseeting->max_days  ?>" class="form-control" placeholder="<?php echo lang("Localize.max_days_for_ticket_booking") ?>">
            </div>
            ...
            <div class="col-md-6 col-xl-3">
                <label for="editadminbackground" class="form-label"><?php echo lang("Localize.admin_login") ?> <?php echo lang("Localize.background") ?> <?php echo lang("Localize.image") ?> </label>
                <div id="editadminbackground">

                </div>
                <input type="hidden" id="oldadminbackground" name="oldadminbackground" value="<?php echo $webseeting->adminbackground ?>">
            </div>
            ...
            <div class="col-md-6 col-xl-3 ">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="pay_later" id="visible" value="1" <?php echo ($webseeting->pay_later == '1') ? 'checked' : '' ?>>
                    <label class="form-check-label" for="visible">
                        <?php echo lang("Localize.visible") ?>
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="pay_later" id="not_visible" value="0" <?php echo ($webseeting->pay_later == '0') ? 'checked' : '' ?>>
            ...
            <div class="col-md-6 col-xl-3">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="luggage_service" id="luggage_service_on" value="1" <?php echo ($webseeting->luggage_service == '1') ? 'checked' : '' ?>>
                    <label class="form-check-label" for="luggage_service_on">
                        <?php echo lang("Localize.active") ?>
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="luggage_service" id="luggage_service_off" value="0" <?php echo ($webseeting->luggage_service == '0') ? 'checked' : '' ?>>
            ...
            <div class="col-md-6 col-xl-3">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="chat_tawk" id="chat_tawk_on" value="1" <?php echo ($webseeting->chat_tawk == '1') ? 'checked' : '' ?>>
                    <label class="form-check-label" for="chat_tawk_on">
                        <?php echo lang("Localize.active") ?>
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="chat_tawk" id="chat_tawk_off" value="0" <?php echo ($webseeting->chat_tawk == '0') ? 'checked' : '' ?>>
