...
class Rating extends BaseController
{
	...
	public function index()
	{
		...
		$data['rating'] = $this->ratingModel->
		select('ratings.*,user_details.first_name,user_details.last_name,l_p.name AS pl_name, l_d.name AS dl_name')
		->join('user_details','user_details.user_id = ratings.user_id','left')
		->join('trips','trips.id = ratings.trip_id','left')
	...
	public function update($id)
	{
		...
		if ($validation->setRules($validationRules)->run($validateData)) 
		{
