<?php echo $this->extend('template/admin/main') ?>
	...
	<div class="card mb-4">
      <div class="card-body">
		...
		<form action="<?php echo base_url(route_to('update-razor', $razor->id)) ?>" id="razoredit" method="post" class="row g-3" accept-charset="utf-8" enctype="multipart/form-data">
					...
					<div class="col-4">
						...
						<div class="row">
												...
												<label for="live_s_kye" class=""><?php echo lang("Localize.live") ?> <?php echo lang("Localize.secret") ?> <?php echo lang("Localize.key") ?> </label>	
													<input type="text" id="live_s_kye" name ="live_s_kye" value="<?php echo esc(old('live_s_kye') ?? $razor->live_s_kye )  ?>" class="form-control"  placeholder="<?php echo lang("Localize.live") ?> <?php echo lang("Localize.secret") ?> <?php echo lang("Localize.key") ?>">
												</div>


												<div class="col-12 mt-3">
												<label for="test_s_kye" class=""><?php echo lang("Localize.test") ?> <?php echo lang("Localize.secret") ?> <?php echo lang("Localize.key") ?></label>	
													<input type="text" id="test_s_kye" name ="test_s_kye" value="<?php echo esc(old('test_s_kye')) ?? $razor->test_s_kye ?>" class="form-control"  placeholder="<?php echo lang("Localize.test") ?> <?php echo lang("Localize.secret") ?> <?php echo lang("Localize.key") ?>">
												</div>
