<?php echo $this->extend('template/admin/main') ?>
	...
	<div class="card mb-4">
      <div class="card-body">
			...
			<form action="<?php echo base_url(route_to('create-paystack'))?>" id="paystackform" method="post" class="row g-3" accept-charset="utf-8" enctype="multipart/form-data">
				...
				<div class="row">
					...
					<div class="col-8">
						...
						<label for="name" class=""> <?php echo lang("Localize.live") ?> <?php echo lang("Localize.private") ?> <?php echo lang("Localize.key") ?> </label>	
							<input type="text" id="live_p_kye" name ="live_p_kye" value="<?php echo esc(old('live_p_kye'))  ?>" class="form-control"  placeholder="<?php echo lang("Localize.live") ?> <?php echo lang("Localize.private") ?> <?php echo lang("Localize.key") ?> ">
						</div>
						...
						<label for="test_p_kye" class=""><?php echo lang("Localize.test") ?> <?php echo lang("Localize.private") ?> <?php echo lang("Localize.key") ?> </label>	
							<input type="text" id="test_p_kye" name ="test_p_kye" value="<?php echo esc(old('test_p_kye'))  ?>" class="form-control"  placeholder="<?php echo lang("Localize.test") ?> <?php echo lang("Localize.private") ?> <?php echo lang("Localize.key") ?>">
						</div>
