...
<?php $this->section('content') ?>
    <div class="d-flex align-items-center justify-content-center text-center h-100vh login-section"
     style="background-image: url('data:image/jpeg;base64,<?= $background_image ?>'); background-size: cover; background-position: center; height: 100vh;">
        <div class="form-wrapper m-auto">
            <div class="form-container my-4">
                <div class="panel">
                    <div class="login-splash">
                        <h2><?php echo lang("Localize.admin_login")?></h2>
