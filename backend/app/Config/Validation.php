...
class Validation
{
    ...
    public $layout = [
        'layout_number'     => [
            'rules'  => 'required|is_unique[layouts.layout_number,id,{id}]',
            'errors' => [
    ...
    public $user = [
        'id'    => 'permit_empty|integer',
        'login_email'  => 'required|is_unique[users.login_email,id,{id}]',
    ...
    public $web_ticket_errors = [
        ...
        'passanger_id' => [
            'required' => 'Passanger id is required',
        ],
        'subtrip_id' => [
            'required' => 'Subtrip id is required',
        ],
        'pick_location_id' => [
            'required' => 'Pick location id is required',
        ],
        'drop_location_id' => [
            'required' => 'Drop location id is required',
        ],
        'pick_stand_id' => [
            'required' => 'Pick stand id is required',
        ],
        'drop_stand_id' => [
            'required' => 'Drop stand id is required',
        ],
        'seatnumber' => [
            'required' => 'Seat number is required',
        ],
        ...
        'bookby_user_id' => [
            'required' => 'Bookby user id is required',
        ],
        'journeydata' => [
            'required' => 'Journey data is required',
        ],
        'payment_status' => [
            'required' => 'Payment status is required',
        ],
    ...
    public $luggagesetting = [
        'free_luggage_kg'     => 'required',
        'paid_max_luggage_pcs'     => 'required',
        'price_pcs'     => 'required',
        'special_max_luggage_pcs'     => 'required',
        'special_price_pcs'     => 'required',
        'max_length'     => 'required',
        'max_weight'     => 'required',
    ];
    ...
    public $tawk_errors = [
        ...
        'widget_id' => [
            'required' => 'Widget id is required',
        ],
        'status' => [
            'required' => 'status is required',
        ],
