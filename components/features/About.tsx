      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center gap-10">
        ...
        <div className="flex-1 flex flex-col justify-center mt-8 lg:mt-0">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-primary mb-6">
            About Enugu Smart Bus
          </h2>

          <p className="text-base md:text-lg text-gray-600 leading-relaxed mb-8">
            Enugu Smart Bus is a modern public transport system that combines
            comfort, safety, and technology to transform the way people move
            across Enugu State. Our eco-friendly CNG and hybrid buses are
            equipped with real-time GPS tracking, AI-powered route optimization,
            on-board Wi-Fi, digital ticketing, and intelligent safety systems —
            ensuring a smarter, greener, and more convenient journey for all.
          </p>
