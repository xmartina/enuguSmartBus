...
import { getMobileAppData } from '@/lib/api';
import { MobileAppData } from '@/types/api';
...
export default function MobileApp() {
  ...
  useEffect(() => {
    async function fetchData() {
      const data = await getMobileAppData();
  ...
  const defaultData = {
    ...
    sub_title:
      "Enugu's leading tour and travels Booking website. Book travel packages and enjoy your holidays with distinctive experience.",
    image: '/images/mobile.png',
    android_link: '#',
    ios_link: '#',
  };

  const displayData = appData || defaultData;
      ...
      <div className="flex flex-col lg:flex-row items-center gap-10">
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-5">
            {/* App Store Button */}
            <a href={displayData.ios_link} target="_blank" rel="noopener noreferrer">
              <Button
                variant="outline"
                size="lg"
            ...
            {/* Google Play Button */}
            <a href={displayData.android_link} target="_blank" rel="noopener noreferrer">
              <Button
                variant="outline"
                size="lg"
                className="bg-black hover:bg-gray-800 text-white px-6 py-4 rounded-lg flex items-center gap-3 min-w-[150px]"
