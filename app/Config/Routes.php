...
$routes->get('/driver/home', 'DriverHome::index');
...
$routes->get('/modules/backend/payment-system', 'PaymentSystem::index',['filter' => 'authGuard','as' => 'admin-payment-system']);
$routes->get('/modules/backend/driver/home', 'DriverHome::driver',['filter' => 'authGuard','as' => 'driver-home']);
...
$routes->get('/ajax/layout/details/(:num)', 'AjaxController::getLayoutDetailsbyId/$1');
...
// =====================
// ADMIN DRIVER MAP VIEW & LIVE LOCATION
// =====================
$routes->group('admin', ['namespace' => 'App\Controllers', 'filter' => 'authGuard'], function($routes) {
$routes->get('driver-locations', 'DriverHome::driverLocations');
$routes->get('fetch-driver-locations', 'DriverHome::fetchDriverLocations');
$routes->get('driver/(:num)', 'DriverHome::viewDriver/$1');
$routes->get('fetch-single-driver/(:num)', 'DriverHome::fetchSingleDriver/$1');
});
/*
 * --------------------------------------------------------------------
 * Additional Routing
